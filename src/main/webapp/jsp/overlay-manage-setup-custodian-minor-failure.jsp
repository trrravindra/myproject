...
<div class="custodian accept-being-custodian" role="dialog" tabIndex="0"
	...
	<div class="header">
		<h1 class="title" id="overlayTitle">
			<spring:message
				code="my.managed.account.minor.custodianship.failureoverlay.title" />
		</h1>
	</div>
	<div class="inner-content" id="overlayDesc">
		<form class="form-details uniform managed-account-response"
			...
			<p class="0 hiddenErrorMessage" tabIndex="0">
				<spring:message
					code="my.managed.account.minor.custodianship.failureoverlay.0" />
			</p>
			<p class="2073 hiddenErrorMessage" tabIndex="0">
				<spring:message
					code="my.managed.account.minor.custodianship.failureoverlay.2073" />
			</p>
			<p class="2084 hiddenErrorMessage" tabIndex="0">
				<spring:message
					code="my.managed.account.minor.custodianship.failureoverlay.2084" />
			</p>
			<p class="2059 hiddenErrorMessage" tabIndex="0">
				<spring:message
					code="my.managed.account.minor.custodianship.failureoverlay.2059" />
			</p>
			<p class="2090 hiddenErrorMessage" tabIndex="0">
				<spring:message
					code="my.managed.account.minor.custodianship.failureoverlay.2090" />
			</p>
