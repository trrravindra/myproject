...
<div class="card find-pharmacy last">
	<div class="header">
		<div class="inner">
			<h3 class="title">
				<spring:message code="home.find.pharmacy.heading.QC" />
			</h3>
		</div>
	</div>
			...
			<div class="inner">
               ...
               Pharmacy department code -->
				...
				<form class="uniform form-find-pharmacy"
					...
					<input type="hidden" name="departments" value="300064QC" /> <input
						type="hidden" name="proximity" value="50" /> <input type="hidden"
						name="stores" value="10" />
