...
<div class="content">
	...
	<c:choose>
		<c:when test="${isLoggedInUser}">
			<h1 class="title">
				<spring:message code="caregiver.my.medication.record.title" />
			</h1>
			<spring:message code="caregiver.my.medication.record.message" />
		</c:when>
		<c:otherwise>
			<h1 class="title">
				<spring:message code="caregiver.medication.record.title" />
