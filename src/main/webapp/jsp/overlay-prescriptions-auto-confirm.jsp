		...
		<div class="overlay">
			<div class="auto-refill-opted-in" role="dialog" tabIndex="0"
				...
				<div class="header" id="overlayTitle">
					<h1 class="title">
						<spring:message code="confirm.refill.reminder.overlay.title.label"
							arguments="${firstName}, ${lastName}" htmlEscape="false" />
					</h1>
				</div>
				<div class="inner-content" id="overlayDesc">
					<p>
						<spring:message
							code="confirm.refill.reminder.overlay.description.text"
							arguments="${reminderDays}" htmlEscape="false" />
					</p>
					<p>
						...
						<c:if
							...
							<strong>(${fn:substring(entityPatient.phoneNumber, 0, 3)})&nbsp;
