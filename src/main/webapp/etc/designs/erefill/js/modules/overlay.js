define(
    [
        ...
        'stapes',
        'require',
        'tpl!templates/global.overlay-general.html'
    ],
    ...
    function(
        ...
        function getFirstScrollingEl(query){
            ...
            if (!$els.length){
                // If there are no proper elements, which
                // only seems to happen in Safari, we'll assume
        ...
        Overlay.prototype = {
            ...
            close: function(callback){
                ...
                if ( dfdObj.init ){
                    ...
                    this.el.fadeOut(this.config.duration).promise().done(function () {
                ...
                $.when( dfd.promise() ).then(function(){
                    ...
                    if ( !opts.refresh && newOverlay ){
                        ...
                        opts = $.extend({
                            ...
                            closeButtons: '.close, .cancel, .inner',
