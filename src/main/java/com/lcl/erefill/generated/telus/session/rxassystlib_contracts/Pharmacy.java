...
public class Pharmacy {
    ...
    @XmlElementRef(name = "ImageChecksum", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<String> imageChecksum;
    @XmlElementRef(name = "Message", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PharmacyOpeningHours", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
