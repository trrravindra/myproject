 ...
 *     &lt;enumeration value="ClinicManager"/>
 *     &lt;enumeration value="Implementor"/>
 *     &lt;enumeration value="CustomerServiceSupervisor"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum EAccountType {
    ...
    @XmlEnumValue("ClinicManager")
    CLINIC_MANAGER("ClinicManager"),
    @XmlEnumValue("Implementor")
    IMPLEMENTOR("Implementor"),
    @XmlEnumValue("CustomerServiceSupervisor")
    CUSTOMER_SERVICE_SUPERVISOR("CustomerServiceSupervisor");
