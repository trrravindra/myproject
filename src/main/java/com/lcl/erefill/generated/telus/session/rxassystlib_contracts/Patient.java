...
import com.lcl.erefill.generated.telus.session.rxassystlib.EGender;
import com.lcl.erefill.generated.telus.session.rxassystlib.ELanguage;
import com.lcl.erefill.generated.telus.session.rxassystlib.EPHNType;
import com.lcl.erefill.generated.telus.session.rxassystlib.EProvince;
...
public class Patient {
    ...
    @XmlElementRef(name = "UserName", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<String> userName;
    @XmlElement(name = "Weight")
    protected int weight;
    @XmlElement(name = "WorkPhoneNumber", required = true, nillable = true)
    protected String workPhoneNumber;
    @XmlElementRef(name = "BirthDateV2", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> birthDateV2;
    @XmlElementRef(name = "HeightWeightModificationDateV2", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> heightWeightModificationDateV2;
    @XmlElementRef(name = "CreationDateV2", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> creationDateV2;
    @XmlElementRef(name = "ModificationDateV2", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> modificationDateV2;
    @XmlElementRef(name = "FacilityDepartureDateV2", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> facilityDepartureDateV2;
    @XmlElementRef(name = "FacilityReturnDateV2", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> facilityReturnDateV2;
    @XmlElementRef(name = "DefaultPharmacy", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Data", type = JAXBElement.class, required = false)
