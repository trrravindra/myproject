...
import com.lcl.erefill.generated.telus.session.rxassystloggerlib.SimpleError;
    ...
    extends SimpleError
{
    ...
    @XmlElementRef(name = "UserToken", namespace = "http://schemas.datacontract.org/2004/07/RxAssystLib.Contracts.Error", type = JAXBElement.class, required = false)
